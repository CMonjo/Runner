...
void init_objects(sys_t *sys)
{
	...
	for (i = 0; i < 8; i++)
		sys->bg[i] = NULL;
	sys->bg[0] = add_sprite_bg("assets/img/hud/menu.jpg", (sfVector2f){0, 0}, (sfIntRect){0, 0, 1920, 1080});
	sys->bg[1] = add_sprite_bg("assets/img/hud/coins.png", (sfVector2f){1160, 550}, (sfIntRect){0, 0, 200, 300});
	sys->bg[2] = add_sprite_bg("assets/img/hud/red.png", (sfVector2f){800, 350}, (sfIntRect){0, 0, 73, 73});
	sys->bg[3] = add_sprite_bg("assets/img/hud/blue.png", (sfVector2f){800, 450}, (sfIntRect){0, 0, 73, 73});
...
void init_text_menu(sys_t *sys)
{
	...
	for (i = 0; i < 10000; i++)
		sys->menu[i] = NULL;
	sys->menu[0] = set_text("assets/font/bold.ttf", (sfVector2f){0, 0}, "Score", 50);
	sys->menu[1] = set_text("assets/font/bold.ttf", (sfVector2f){1000, 350}, "Runner", 150);
	sys->menu[2] = set_text("assets/font/bold.ttf", (sfVector2f){300, 350}, "Play", 50);
	sys->menu[3] = set_text("assets/font/bold.ttf", (sfVector2f){300, 450}, "Infinite mode", 50);
	sys->menu[4] = set_text("assets/font/bold.ttf", (sfVector2f){300, 550}, "Option", 50);
	sys->menu[5] = set_text("assets/font/bold.ttf", (sfVector2f){300, 650}, "RageQuit", 50);
	sys->menu[6] = set_text("assets/font/bold.ttf", (sfVector2f){900, 350}, "Red", 100);
	sys->menu[7] = set_text("assets/font/bold.ttf", (sfVector2f){900, 450}, "Blue", 100);
	sys->menu[8] = set_text("assets/font/bold.ttf", (sfVector2f){900, 550}, "Back", 100);
...
void move_player(sys_t *sys)
{
	...
	if (sys->obj[0]->rect.top >= max_value_p - sys->obj[0]->rect.width)
		...
		sys->obj[0]->rect.top = sys->obj[0]->rect.top + sys->obj[0]->rect.width;
}
